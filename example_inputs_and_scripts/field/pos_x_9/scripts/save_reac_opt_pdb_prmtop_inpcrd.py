...
opt_geoms = sorted((glob.glob('rep_101/a_reac/reac_opt.pdb')))
prmtops   = sorted((glob.glob('rep_101/initial_struc/reac.prmtop')))
...
for i in np.arange(len(prmtops)):
    ...
    print( 'Saved optimised reactant files for '+ rep_string)
