...
dna = pmd.load_file('dna_r_opt.prmtop', 'dna_r_opt.inpcrd')
...
dna.save('../initial_struc/dna_p.inpcrd', overwrite=True)
dna.save('../initial_struc/dna_p.prmtop', overwrite=True)
dna.save('../initial_struc/dna_p.pdb', overwrite=True)
