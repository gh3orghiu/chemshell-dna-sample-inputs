...
dna = pmd.load_file('dna_r_re.prmtop', 'dna_r_re.inpcrd')
...
dna.save('dna_p.inpcrd', overwrite=True)
dna.save('dna_p.prmtop', overwrite=True)
dna.save('dna_p.pdb', overwrite=True)
